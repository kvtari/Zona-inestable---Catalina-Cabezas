...
// ==========================================
// 1. CONFIGURACIÓN BASE (ESTÉTICA VECTORIAL)
// ==========================================

const scene = new THREE.Scene();
// Usamos el mismo color de relleno para el fondo, o puedes dejarlo blanco/crema si prefieres que la pieza resalte.
// Aquí lo dejé un tono ligeramente más claro que tu pieza para que no se pierda, pero manteniendo tu estética.
...
// Los colores exactos que pediste
...
// ==========================================
// 4. CONSTRUCCIÓN EXACTA DE LA PIEZA (ASIMÉTRICA)
// ==========================================
...
// ENSAMBLAJE (Base lisa abajo, collar arriba)

// 1. DISCO BASE CENTRAL
// Nace desde su mitad negativa y crece hacia arriba
const capaCirculo = crearCapa(circleShape, GROSOR_CIRCULO, - (GROSOR_CIRCULO / 2)); 
baseZocaloGroup.add(capaCirculo);

// 2. COLLAR SUPERIOR
// Nace exactamente donde termina el círculo y crece hacia arriba.
// El agujero cuadrado permite ver el disco base.
...
// ==========================================
// 5. INTERACCIÓN (RAYCASTER Y ROTACIÓN LIBRE)
// ==========================================
